...
CHNG_HR_MIN:							;start seconds counter from 0s
	...
	MVI A,00H
INCR_SEC:
	STA CURDT                   ;Insert Accumulator Value : 00H at CURDT
    CALL CHECK
                     ;update display of data field and takes data from CURDT and display at data field
	CALL DELAY
    CALL UPDAD					;update display of address field and takes data from CURAD and display at address field
	CALL UPDDT
    				;call delay which runs for 1second
	LDA CURDT
	ADI 01H
    DAA
